...
seminar_page('勉強会企画｜案B 不動産会社',
    ...
    '3案のなかで最も件数が多く、名簿獲得という目的では最も効く。'
    '訴求は「管理手数料以外の収益源をつくる」。当日は物件価値と入居率への効果を示し、'
    'オーナーへの案内という形で名簿の共有範囲を確認する。'
    '1回目（案A）の反応を見てから実施する想定。',
    '開催日時、登壇者、不動産向けDMリストの入手')

# --- 26 勉強会企画｜案C 電気・設備 ---
seminar_page('勉強会企画｜案C 電気・設備工事',
    [('■　対象は', T_LEAD, INK), ('電気工事・設備工事会社', T_LEADEM, RED),
     ('。施工済み顧客の更新期が読める', T_LEAD, INK)],
    '過去の顧客名簿を売上に変える', '既存客の蓄電池リプレイス提案セミナー',
    ['・Zoomウェビナー（90分）', '・対象 電気工事・設備工事',
     '・定員 30社（1社2名まで）', '・参加費 無料', '・開催日【　　月　　日】'],
    ['・第1部 蓄電池の更新需要と時期', '・第2部 既存客への案内のしかた',
     '・第3部 共同提案モデルの解説', '・第4部 収益試算と個別相談の案内'],
    ['・終了時に個別面談を案内', '・施工済み顧客の件数を確認',
     '・共同提案の役割分担を詰める', '・参加9社 → 提携1.5社が目標'],
    [('1.5ヶ月前｜告知', ['・電気工事組合へDM', '・メルマガで初告知']),
     ('1ヶ月前｜追込み', ['・反応者へ架電', '・メルマガ2回目']),
     ('2週間前｜確定', ['・受講URLを案内', '・欠席防止の連絡']),
     ('前日｜最終確認', ['・参加者リスト確定', '・施工実績を事前確認']),
     ('当日｜刈り取り', ['・更新需要の試算を提示', '・個別面談へ誘導'])],
    '施工済み顧客の更新期を押さえれば、名簿が案件に変わる。',
    '案Cの企画シート。対象は電気工事・設備工事会社で、獲得できるのは施工済み顧客の名簿。'
    '設備の更新期が読めるため、いつ当たるかが計算できるのが強み。'
    'TRENDE社が推進する蓄電池レンタル満了顧客へのリプレイス提案とも文脈が近い。'
    '当日は更新需要の試算を示し、共同提案という形で名簿の扱いを詰める。',
    '開催日時、登壇者、電気工事組合へのDM可否')
